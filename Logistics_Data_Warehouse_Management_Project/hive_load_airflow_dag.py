...
create_hive_database = DataprocSubmitHiveJobOperator(
    ...
    cluster_name='cluster-7112',
    region='us-central1',
    project_id='data-engineering-453220',
    dag=dag
)
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistics-raw-gds-123/input_data/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistics-raw-gds-123/input_data/logistics_*.csv gs://logistics-archive-gds-123/",
    dag=dag
)
