...
redshift_jar_path = Path("C:\\Personal\\Projects\\class3\\kafka-spark-redshift-streaming\\redshift-jdbc42-2.1.0.12.jar").resolve().as_uri()
...
spark_redshift_package = "com.databricks:spark-redshift_2.12:4.2.0"

redshift_jar = "file:///C:/Personal/Projects/class3/kafka-spark-redshift-streaming/redshift-jdbc42-2.1.0.12.jar"
...
spark = SparkSession.builder \
    ...
    .config("spark.jars", "/mnt/c/Personal/Projects/class3/kafka-spark-redshift-streaming/redshift-jdbc42-2.1.0.12.jar") \
    .getOrCreate()
...
redshift_jdbc_url = "jdbc:redshift://redshift-cluster-123.cwh3sjcakzc3.eu-north-1.redshift.amazonaws.com:5439/dev"
redshift_table = "telecom.telecom_data"
s3_temp_dir = "s3://s3-temp-location/temp/"
